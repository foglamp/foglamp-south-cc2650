...
_DEFAULT_CONFIG = {
    'plugin': {
         'description': 'TI Sensortag CC2650 (poll)',
         'type': 'string',
         'default': 'cc2650poll'
    },
    'pollInterval': {
        'description': 'Interval between polls of SensorTag in milliseconds',
        'type': 'integer',
        'default': '500'
    },
    'bluetoothAddress': {
    ...
    'connectionTimeout': {
        'description': 'BLE timeout in seconds',
        'type': 'integer',
        'default': '10'
    },
    'shutdownThreshold': {
        'description': 'Time to wait to complete pending tasks before shutdown (seconds)',
        'type': 'integer',
        'default': '10'
    },
    'management_host': {
...
#            },
            'light': {"lux": lux_luminance},
#            'humidity': {
"humidity": {"humidity": rel_humidity},
"temp": {"temp": rel_temperature},
#            },
